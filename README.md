...
- **Advanced Motion Learning**: Specialized in training complex robot behaviors beyond simple locomotion.
- **VLA Integration**: Seamlessly connect Vision-Language-Action models to robot actuators.
- **MuJoCo Native**: Optimized for the MuJoCo physics engine for fast and stable simulation.
- **Multi-Dataset Support**: Built-in compatibility with OXE, LeRobot, and Droid dataset formats.
